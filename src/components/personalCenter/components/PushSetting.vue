<template >
  <div class="inwrap">
    ...
    <mt-popup id="NewPush" class="wh100" v-model="apss.aa" popup-transition="popup-fade" :modal=false>
      <NewPush  ref="NewPush" v-on:onChangePss="onChangePss" @fetchTheme="fetchTheme"></NewPush>
    </mt-popup>
    <mt-popup id="EditPush" class="wh100" v-model="apss.bb" popup-transition="popup-fade" :modal=false>
      <EditPush  :editem='editem' ref="EditPush" v-on:onChangePss="onChangePss" @fetchTheme="fetchTheme"></EditPush>
    </mt-popup>
  </div>
</template>
<script>
