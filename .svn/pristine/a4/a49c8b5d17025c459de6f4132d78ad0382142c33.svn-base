...
<div class="warp">
  ...
  <div class="module module5">
    ...
    <div class="chartDetail">在媒体来源中，{{detailObj.top1Name}}对此次事件的曝光力度最大，占所有媒体之首，在{{detailObj.dataDes}}内有{{detailObj.top1Count}}条舆情信息，{{detailObj.top2Name}}位居第二，有{{detailObj.top2Count}}条舆情信息。</div>
  </div>
