<template>
  <div class="ratings">
    <div class="title">
      <h2>
        <div class="bigTitle"  style="height:40px;">
          <span class="menuTitle" v-on:click="openMenu()">
            {{BigthemeName}}
            <i v-if="isicon" class="posIcon iconfont icon-caret"></i>
            <i v-if="!isicon" class="posIcon icon-shangla  iconfont"></i>
          </span>

        </div>
        <ul class="bigTitle-item" v-if="seen && themeList.length > 1">
      ...
      <i class="shuaxin iconfont icon-shuaxin" v-on:click="shuaxin"></i>
      <i class="time iconfont icon-shijian1 " v-bind:class="{ active:isActive1}" v-on:click="time"></i>
      <i class="share iconfont icon-fenxiang" v-bind:class="{active:isActive2}" v-on:click="share" v-if="isAppClient" id="shareTu"></i>
    </div>
    ...
    <div class="tabContent">
      <div class="bigMoudle bigMoudle1">
        <div class="moudle moudle11">
          <div class="moudleTitle">声量走势</div>
          <div class="moudleContent">
            <div id="chart11" v-show="!chart11Img" style="height:274px;width:100vw;"></div>
            <div class="chart11Img"  v-show="chart11Img">
                <ongLoading ></ongLoading>
            </div>
          </div>
        ...
        <div class="moudle moudle12">
          ...
          <div class="moudleContent">
            <div id="chart12" v-show="!chart12Img && !chart12Data" style="height:210px;width:100vw;"></div>
            <div class="chart12Img" v-show="chart12Img">
                <ongLoading ></ongLoading>
            </div>

            <div class="chart12Img" v-show="chart12Data">
                <notData></notData>
            </div>
          </div>
        ...
        <div class="moudle moudle13">
          ...
          <div class="moudleContent">
            <div id="chart13"  v-show="!chart13Img && !chart13Data" style="height:210px;width:100vw;"></div>
            <div class="chart13Img"  v-show="chart13Img" style="height:210px;width:100vw;">
                <ongLoading ></ongLoading>
            </div>

            <div class="chart13Img"  v-show="chart13Data" style="height:210px;width:100vw;">
                 <notData></notData>
            </div>
      ...
      <div class="bigMoudle bigMoudle2">
        <div class="moudle moudle21">
          ...
          <div class="moudleContent">
            <div id="chart21" v-show="!chart21Img" style="height:274px;width:100vw;"></div>
             <div class="chart21Img"  v-show="chart21Img" style="height:274px;width:100vw;">
                <ongLoading ></ongLoading>
            </div>
        ...
        <div class="moudle moudle22">
          ...
          <div class="moudleContent">
            <div id="chart22" v-show="!chart22Img" style="height:210px;width:100vw;"></div>
            <div class="chart22Img"  v-show="chart22Img">
                <ongLoading ></ongLoading>
            </div>
          </div>
        ...
        <div class="moudle moudle23">
          ...
          <div class="moudleContent">
            <div id="chart23" v-show="!chart23Img && !chart23Data" style="height:210px;width:100vw;"></div>
            <div class="chart23Img"  v-show="chart23Img">
                <ongLoading ></ongLoading>
            </div>

             <div class="chart23Img"  v-show="chart23Data">
                <notData ></notData>
            </div>
          </div>
      ...
      <div class="bigMoudle bigMoudle3">
        <div class="moudle moudle31">
          <div class="moudleContent">
            <div id="chart31" v-show="!chart31Img" style="height:300px;width:100vw;"></div>
            <div class="chart31Img"  v-show="chart31Img">
                <ongLoading ></ongLoading>
            </div>
          </div>
        </div>
        <div class="moudle moudle32">
          <div class="moudleContent" style="min-height:600px;">
            <div class="informationtip" v-show="!chartTopList">
              <dl>
          ...
          <div class="chart31Img" v-show="chartTopList">
             <ongLoading ></ongLoading>
          </div>
...
<script>
  ...
  import {isAppClient,isIOS} from 'common/js/common'
  export default {
    data(){
      return {
...
//      console.log('缓存的组件又出现了，我是不是要重新拉取数据呢？')
      if(!!this.$store.state.user.reflash[1]){
        this.initPage();
      }
    },
    watch:{
    ...
    methods: {
      ...
      openMenu:function(){
        ...
        {
          this.seen=!this.seen;
          this.ismengcengshow=!this.ismengcengshow;
...
/*
      ...
      upLoadImg:function(falg,callback){
          console.log(!!this.chart11obj,!!this.chart12obj,!!this.chart13obj,!!this.chart21obj,!!this.chart22obj,!!this.chart23obj,!!this.chart31obj)
         if(!this.chart11obj&&!this.chart12obj&&!this.chart13obj&&!this.chart21obj&&!this.chart22obj&&!this.chart23obj&&!this.chart31obj){
            alert("图表加载不全，无法分享");
           Indicator.close();
            return false;
         }
      ...
      initPage:function(){
        if(isIOS){
          window.location.href="checkPlaform://check?fun=checkInstall";
        }
        this.$store.commit('reflashClear','1');
      ...
      fncharts11: function (id) {
        ...
        var _this=this;
         _this.chart11Img = true;
//         console.log("hahaha:"+ themeId)
...
//             console.log("走到这里了图1为："+_this.chart11Img)
...
//            console.log("无DATA")
       ...
       // _this.chart11Img = false;
//        console.log("this.chart11Img: "+this.chart11Img)
      }
      ,
      fncharts12: function (id) {
        ...
        var timeType = this.timeType;
        var _this=this;
        _this.chart12Img = true;
        _this.chart12Data = false;
        axios.post('/themeapp/analysis', qs.stringify({
          'userId': userId,
          'themeId': themeId,
          'timeType':timeType,
          ...
          if (data) {
            ...
            _this.chart12Img = false;
//             console.log("走到这里了图2为："+_this.chart12Img)
      ...
      fncharts13: function (id) {
        ...
        var timeType = this.timeType;
        var _this=this;
        _this.chart13Img = true;
        _this.chart13Data = false;
        axios.post('/themeapp/analysis', qs.stringify({
          'userId': userId,
          'themeId': themeId,
          'timeType':timeType,
      ...
      fncharts23: function (id) {
        ...
        var timeType = this.timeType;
        var _this=this;
          _this.chart23Img = true;
          _this.chart23Data = false;
        axios.post('/themeapp/analysis', qs.stringify({
          'userId': userId,
          'themeId': themeId,
          'timeType':timeType,
...
//            console.log(data);
      ...
      fncharts31: function (id) {
        ...
        var timeType = this.timeType;
        var _this=this;
         _this.chart31Img = true;
        _this.chartTopList = true;
        axios.post('/themeapp/analysis', qs.stringify({
          'userId': userId,
          'themeId': themeId,
          'timeType':timeType,
          ...
          if (data) {
            ...
            var options = {
              tooltip: {
                ...
                borderWidth: 1,
                formatter: "<a style='color:#ff0000;font-weight:600; font-size:16px;'>{b}</a> <br> 信息数<a style='color:#ff5a00;font-weight:600; font-size:16px;'>{c}</a>",
                padding: 10,
              },
              visualMap: {
                type: 'piecewise',
