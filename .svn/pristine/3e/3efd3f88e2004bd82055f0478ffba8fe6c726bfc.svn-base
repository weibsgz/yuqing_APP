...
//                console.log("列表传送的数据：" + JSON.stringify(listData));
            ...
            onlyRenderNewsList:function(){
                ...
                .then(axios.spread(function(list){
                    ...
                    if (_this.page > 1 && parseInt(_this.page) >= parseInt(list.data.pager.allPage) ) {
                            Toast({
                                message: '已加载完成',
                                position: 'middle',
                                duration: 1000,
            ...
            render: function() {
                ...
                .then(axios.spread(function(keywordRes,list){
                    ...
                    //如果新添加完主题 ，设置themeId为空，保证刷新列表是第一个
                  /*  if(!!this.$store.state.user.reflash[0]){
                         _this.firstThemeId = keywordRes.data.themeList[0].themeId
                    }*/
