<template lang="html">
    <div class="yuqingdongtai yqdt inwrap" :class="{showCpts:pss,hideCpts:(!this.pss&&off)}">
        ...
        <div class="content">
            <mt-loadmore v-if="loaded" :top-method="loadTop" :bottom-method="loadBottom" :auto-fill="false" ref="loadmore" :bottom-all-loaded="allLoaded" @top-status-change="handleTopChange">
                <ul class="ulNews">
...
.yqdt .content ul li.moreSimilar {
    border-bottom: none;
    text-align: center;
    font-size: 14px;
    color: #ff3333;
